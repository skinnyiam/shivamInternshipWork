...
const OverpayInfo = () => {
  return (
    <>
    <div className="bg-[#194BFB] h-screen w-1/2 flex justify-center items-center">
      ...
      <div className="absolute left-[54%] right-[39%] top-[88%] bottom-[3%]">
